...
public:  // Setter	
	...
	void    AddTileHalf(int X, int Y, int half1, int half2, int nOrder, int nType, int nObjectType, wstring strImageFile, Vector2 offset, Vector2 offsetSize, Vector3 rotation, int IsAxis);
